 ...
 * maintaining a list of {@link Display2} instances responsible for rendering
 ...
 * 
 * <p>Visualizations also maintain references to all the {@link Display2}
 * instances providing interactive views of the content of this
 * visualization. {@link Display2} instances registers themselves with
 * the visualization either in their constructor or through
 * the {@link Display2#setVisualization(Visualization)} method, so they
...
//            getDisplay(i).repaint();
    ...
    public Rectangle2D getBounds(String group) {
        return getBounds(group, new Rectangle2D(0, 0, 0, 0));
    }
...
//            Rectangle2D.union(item.getBounds(), r, r);
     ...
     * {@link prefuse.Display2#setVisualization(Visualization)} method.
