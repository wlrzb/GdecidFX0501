...
public class PrefuseLib {
     ...
     */
    public static String getDisplayStats(Display2 d) {
    ...
    public static Schema getVisualItemSchema() {
        ...
        // bounding box
        s.addColumn(VisualItem.BOUNDS, Rectangle2D.class, new Rectangle2D(0, 0, 0, 0));
        ...
        // font
        Font defFont = FontLib.getFont("SansSerif", "Normal", 8);
