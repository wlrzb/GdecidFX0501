...
public class Display2 extends JComponent {
    ...
    private static final Logger s_logger 
        = Logger.getLogger(Display2.class.getName());
     ...
     */
    public Display2(Visualization visualization) {
     ...
     */
    public Display2(Visualization visualization, String predicate) {
        this(visualization,
     ...
     */
    public Display2(Visualization visualization, Predicate predicate) {
