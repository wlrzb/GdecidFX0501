...
//    protected AffineTransform m_transform = new AffineTransform();
    ...
    public void render(Display display, VisualItem item) {
        Rectangle2D shape = getShape(item);
//        if (shape != null)
...
//    }
     ...
     */
    public Rectangle2D getShape(VisualItem item) {
        Rectangle2D rawShape = getRawShape(item);
        return rawShape;
    }
...
//    }
     ...
     */
    protected abstract Rectangle2D getRawShape(VisualItem item);
...
//    }
    ...
    public void setBounds(VisualItem item) {
        ...
        if ( shape == null ) {
            ...
            GraphicsLib.setBounds(item, shape);
        }
    }
