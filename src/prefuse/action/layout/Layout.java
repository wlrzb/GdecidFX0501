...
public abstract class Layout extends GroupAction {
    ...
    protected Rectangle2D m_tmpb   = new Rectangle2D(0, 0, 0, 0);
    protected Point2D     m_tmpa   = new Point2D(0, 0);
    ...
    public void setMargin(int top, int left, int bottom, int right) {
    	m_insets = new Insets(top, right, bottom, left);
        m_margin = true;
    }
    ...
    public Rectangle2D getLayoutBounds() {
        ...
        if ( m_vis != null && m_vis.getDisplayCount() > 0 )
        {
            ...
            m_bpts[0] = i.getLeft(); 
            m_bpts[1] = i.getTop();
            m_bpts[2] = d.getPrefWidth()-i.getRight();
            m_bpts[3] = d.getPrefHeight()-i.getBottom();
